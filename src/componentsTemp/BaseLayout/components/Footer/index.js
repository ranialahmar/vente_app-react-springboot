...
render(){
  return(
   ...
   <div className="footer">
      <Container>
       <Row>
        <Col  style={{textAlign: 'center', paddingTop:'50px'}}><h2> Buy and sell your clothes..</h2><br/>
        </Col>
      </Row> 
      <Row>
       <Col md='4'><br/></Col>
      ...
      <Row>
       <Col md='4'></Col><Col md='4' style={{textAlign: 'center'}}><h4>Made with Love in Tunis.</h4> © 2019 Copyright Rania Lahmar</Col>
       <Col md='4'></Col>
      </Row>
      </Container>
